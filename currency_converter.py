# # Python Project on Real time Currency Converter using tkinter, requests and API (free API : https://api.exchangerate-api.com/v4/latest/USD)
...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        self.date_label = Label(
            self, text=f"1 US Dollar equals = {self.currency_converter.convert('USD','INR',1)} INR \n Date : {self.currency_converter.data['date']}", relief=tk.GROOVE, borderwidth=5)
